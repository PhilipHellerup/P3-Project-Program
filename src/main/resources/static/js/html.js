...
function statusToColors(statusName) {
    switch (statusName) {
        ...
        case 'delivered':    return { backgroundColor:'#1cc88a', borderColor:'#17a673', textColor:'#000', cssClass:'status-delivered' };
        case 'inProgress':   return { backgroundColor:'#4e73df', borderColor:'#2e59d9', textColor:'#000', cssClass:'status-inProgress' };
        case 'missingPart':  return { backgroundColor:'#f6b3b0', borderColor:'#e07a78', textColor:'#000', cssClass:'status-missingPart' };
        case 'finished':     return { backgroundColor:'#858796', borderColor:'#6c6c7a', textColor:'#000', cssClass:'status-finished' };
        case 'pickedUp':     return { backgroundColor:'#8e44ad', borderColor:'#732d91', textColor:'#000', cssClass:'status-pickedUp' };
        default:             return { backgroundColor:'#858796', borderColor:'#6c6c7a', textColor:'#000', cssClass:'status-finished' };
    }
}
